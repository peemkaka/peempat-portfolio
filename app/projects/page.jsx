...
const works = [
  {
    ...
    live: "https://peempat-foodorder.netlify.app/",
  ...
  },
  {
    ...
    title: "Medium Clone",
    description:
      "A Medium-like blog platform built with React, Vite, Tailwind CSS, and Firebase. (features in readme on github)",
    stack: [
      { name: "React.js" },
      { name: "Tailwind.css" },
      { name: "Vite" },
  ...
  },
  {
    ...
    description:
      "A website about admin team of gkull management about product and account",
    stack: [
      { name: "Next.js" },
      { name: "Ant Design" },
      { name: "Tailwind.css" },
  ...
  },
  {
    ...
    description:
      "A website that collects information, contact channels and my work.",
    stack: [
      { name: "Next.js" },
      { name: "Tailwind.css" },
      { name: "Framer Motion" },
  ...
  },
  {
    ...
    title: "Auth System",
    description:
      "Auth System using firebase authentication / Easy Note (todo website) ",
    stack: [
      { name: "React.js" },
      { name: "Tailwind.css" },
      { name: "Firebase" },
  ...
  },
  {
    ...
    description:
      "My responsible is Front-End Developer for coding Front-End user interface functions, developing CRUD function by using Next.js and tailwind css , managing Line OA and using LIFF(LINE Front-End Framework) for working with web application",
    stack: [
      { name: "React.js" },
      { name: "Tailwind.css" },
      { name: "Spring boot" },
